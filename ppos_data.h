...
//    int task_static_prio; // task static priority
// 
//    int task_dinamic_prio; // task dinamic priority

   unsigned int start_time; // task start time
   unsigned int exc_time; // task estimate execution time
   unsigned int running_time; // time this task has consumed
   unsigned int remaining_time;
   int quantum;
   int is_user_task;
   int task_activations;
